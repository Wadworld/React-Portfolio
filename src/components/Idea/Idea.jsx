  ...
  return (
    <section className='bg-cover bg-center py-10 px-5 lg:px-20 rounded-2xl text-white my-20' style={{ backgroundImage: `url(${Bg})` }}>
      <div>
        ...
        <p className='text-lg font-medium my-3 mb-8 lg:px-60 text-center md:text-center'>Let's collaborate and create something amazing together. Whether it's a web application, mobile app, or Shopify Store project. I'm here to help turn your vision into reality.</p>
        <div className='flex flex-col md:flex-row md:justify-center items-center md:gap-1 gap-3 m-4'>
            <a href="#contact" className='inline-flex items-center bg-white hover:scale-105 text-black md:text-2xl py-3 px-8 mb-2 rounded-lg transition'>
                Get In Touch
