  ...
  return (
    <section>
      <div>
        ...
        <h2 className='text-3xl md:text-6xl font-semibold mt-4'>I'm Wadood Adedimeji <br /> I build <span className='font-bold hover:underline '>impactful</span> websites, Shopify Store and Email Marketing.
        </h2>
